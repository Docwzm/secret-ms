    ...
    return (
      <div className="archives-wrap">
        ...
        >
          ...
          {buttonAuth(buttonKey,'crf_use_medication',<TabPane tab="用药记录" key="6"><DrugRecord ref={ref => this.drugRef = ref} currentType={currentType} patientId={patientId}/></TabPane>)}
          {buttonAuth(buttonKey,'crf_special_event',<TabPane tab="特殊事件" key="7"><CrfReport currentType={currentType} patientInfo={patientInfo} patientId={patientId}/></TabPane>)}
        </Tabs>
      </div>
    );
  }
