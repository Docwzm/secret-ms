            ...
            <div>
                <Form labelalign="left" {...formItemLayout} onSubmit={this.handleSubmit.bind(this)}>
                    <FormItem label="糖尿病慢性微血管并发症">
                        ...
                        }
                        {
                            getFieldValue('diabeticComplicationFlag') ?
                                <FormItem>
                                    <FormItem label="糖尿病视网膜病变" {...formItemLayout}>
                                        {
                                    ...
                                    <FormItem label="糖尿病肾病" {...formItemLayout}>
                                        {
                                    ...
                                    <FormItem label="糖尿病神经病变" {...formItemLayout}>
                                        {
                    ...
                    <FormItem label="糖尿病大血管病变">
                        ...
                        {
                            getFieldValue('diabeticMacroangiopathyFlag') ? <FormItem>
                                <FormItem label="冠状动脉粥样硬化性心脏病史" {...formItemLayout2}>
                                    {
                                ...
                                <FormItem label="行PCI或血管重建术" {...formItemLayout2}>
                                    {
                                ...
                                <FormItem label="脑血管意外病史" {...formItemLayout2}>
                                    {
                                ...
                                <FormItem label="其他大血管病变病史" {...formItemLayout2}>
                                    {
